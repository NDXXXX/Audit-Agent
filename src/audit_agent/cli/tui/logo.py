"""Rich-rendered animated cat mascot for the Audit Agent TUI."""
...
def render_logo(
    ...
    *,
    ...
    if state not in _VALID_STATES:
        raise ValueError(f"Unsupported Audit Agent logo state: {state}")
...
class AuditAgentLogo(Static):
    """Animated Audit Agent cat with boot, idle, and workflow-aware states."""
