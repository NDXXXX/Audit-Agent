"""Intent-routing and lightweight-chat prompts for DDclaw Stage 5."""

INTENT_ROUTER_PROMPT = """You are the intent router for ddclaw.
...
CHAT_RESPONDER_PROMPT = """You are DDclaw's lightweight chat node.
