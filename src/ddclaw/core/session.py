"""Persistent conversation sessions scoped to one DDclaw workspace."""
...
from ddclaw.core.paths import ensure_workspace

SESSION_ROOT = ".ddclaw/session"
